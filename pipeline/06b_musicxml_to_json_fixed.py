#!/usr/bin/env python3
"""
Chunk 6 (Fixed): MusicXML → Normalized JSON
Convert the fixed lead-sheet.musicxml to the web repo's Score JSON format.
"""
import json
...
MUSICXML = Path(__file__).parent.parent / "working" / "your-song" / "lead-sheet-fixed.musicxml"
