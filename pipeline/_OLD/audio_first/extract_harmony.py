...
Run with:  python pipeline/audio_first/extract_harmony.py <slug>
"""
import argparse
import json
import os
...
from harmony_utils import retile_durations, dedupe_adjacent_within_measure
...
# straight from that (see harmony_utils.retile_durations) produces
...
# retile_durations() and dedupe_adjacent_within_measure() now live in
# harmony_utils.py (shared with midi_first/extract_midi_harmony.py) —
# imported above.
